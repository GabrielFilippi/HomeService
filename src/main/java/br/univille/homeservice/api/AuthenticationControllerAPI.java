...
import br.univille.homeservice.security.JWTUtil;
...
public class AuthenticationControllerAPI {
    ...
    public ResponseEntity signin(@RequestBody Usuario usuario){
        Usuario usuarioValido = serviceMyUserDetail.buscaUsuarioSenha(usuario.getLogin(), usuario.getSenha());
        UserDetails userDetails = serviceMyUserDetail.loadUserByUsername(usuarioValido.getLogin());
